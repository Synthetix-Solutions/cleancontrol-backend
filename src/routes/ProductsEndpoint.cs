...
public static class ProductsEndpoints {
	...
	private static Ok<Product> DeleteProduct(Guid id) {
		return TypedResults.Ok<Product>(null);
	}

	private static Ok<Product> UpdateProduct(Guid id) {
		return TypedResults.Ok<Product>(null);
	}

	private static Ok<Product> GetProduct(Guid id) {
		return TypedResults.Ok<Product>(null);
	}

	private static Ok<Product> CreateProduct() {
		return TypedResults.Ok<Product>(null);
	}
