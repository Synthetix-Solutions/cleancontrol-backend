...
public static class Products {
	...
	/// <remarks>
	///     This method deletes a product from the database. It does this by finding the product in the database using the
	///     provided product ID.
	///     If the product is not found, it returns a <see cref="ProblemHttpResult" /> with a 404 status code and an error
	///     message.
	///     If the product is found, it is removed from the database and the changes are saved.
	/// </remarks>
	/// <returns>
	///     A <see cref="Results{T1, T2}" /> object that contains either an <see cref="Ok" /> result if the product was
	///     successfully deleted, or a <see cref="ProblemHttpResult" /> with an error message if the product was not found.
	/// </returns>
	...
	/// <param name="db">The database context.</param>
	/// <remarks>
	///     This method updates a product in the database. It does this by finding the product in the database using the
	///     provided product ID.
	///     If the product is not found, it returns a <see cref="ProblemHttpResult" /> with a 404 status code and an error
	///     message.
	...
	///     product, or a <see cref="ProblemHttpResult" /> with an error message if the product was not found.
	/// </returns>
	...
	/// <param name="db">The database context.</param>
	/// <remarks>
	///     This method retrieves a product from the database. It does this by finding the product in the database using the
	///     provided product ID.
	///     If the product is not found, it returns a <see cref="ProblemHttpResult" /> with a 404 status code and an error
	///     message.
	...
	/// </remarks>
	/// <returns>
	///     A <see cref="Results{T1, T2}" /> object that contains either an <see cref="Ok{T}" /> result with the product,
	///     or a <see cref="ProblemHttpResult" /> with an error message if the product was not found.
	/// </returns>
	...
	/// <param name="db">The database context.</param>
	/// <remarks>
	///     This method creates a new product in the database. It does this by creating a new product object with the provided
	///     product details,
	...
	/// <param name="db">The database context.</param>
	/// <remarks>
	///     This method retrieves all products from the database. It does this by selecting all products from the database and
